          ...
          <div class="card">
            ...
            include "../../koneksi.php";
                  ...
                  if (isset($_POST['editkategoribuku'])){
                    $namakategori =$_POST['rubahkategori'];
                  
                  

                  
                  
                  $insert =mysqli_query($conn, "UPDATE kategori_buku SET nama_kategori='$namakategori' WHERE id_kategori = '$id'");
                  if($insert){
            ...
            <div class="card-body">
              ...
              <?php
                            ...
                            $id = $_GET['id'];
                             $sql ="SELECT * FROM kategori_buku WHERE id_kategori = $id LIMIT 1";
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="rubahkategori" value="<?php echo $buku['nama_kategori']; ?>">
                  </div>
                </div>
