        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <a type="button" class="btn btn-outline-success" href="tambahbuku.php">TAMBAH KATEGORI BUKU</a>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Jenis Buku</th>
