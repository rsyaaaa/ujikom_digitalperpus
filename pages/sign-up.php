...
<body class="">
    ...
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../assets/img/buku1.jpg'); background-position: top;">
          ...
          <div class="card z-index-0">
            ...
            include "../koneksi.php";
                ...
                if($insert){
                  ...
                  echo '<script>alert("Maaf, akun gagal dibuat!");</script>';
                }
                } 
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <label for="example-text-input" class="form-control-label" >Level Akun</label>
                  <select name="level"  class="form-select" >
                    <option value="Admin" name="Admin">Admin</option>
                    <option value="Peminjam" name="Peminjam">Peminjam</option>
                  </select>
                
               
                
                <div class="text-center">
                  <button type="submit" name="submit" class="btn bg-warning w-100 my-4 mb-2">Sign up</button>
                </div>
          </div>
        </div>
      </div>
