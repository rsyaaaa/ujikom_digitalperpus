          ...
          <div class="card z-index-0">
            ...
            include "../koneksi.php";
                if (isset($_POST['submit'])){
                  ...
                  mysqli_query($conn,"INSERT INTO user (username, password, email, nama_lengkap, alamat) VALUES ($username, $password, $email, $namalengkap, $alamat)");
                } 
                
                
                
                // echo '<script>alert("Berhasil membuat akun!, anda akan diarahkan ke menu login."); location.href="sign-in.php"; </script>';
                // ?>
            <div class="card-body">
